...
KEYWORD_MAP: dict[str, list[str]] = {
    ...
    "Road Accident": [
        "accident", "crash", "collision", "road", "car", "bike", "truck",
        "vehicle", "hit", "traffic", "run over", "injured on road",
    ],
    "Fire": [
    ...
    "Flood": [
        "flood", "water", "drowning", "dam", "rain", "submerged",
    ...
    "Pregnancy": [
        "pregnant", "pregnancy", "labor", "delivery", "contractions",
